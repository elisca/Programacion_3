<?php
    ...
    echo "ALTA DE AUTOS:<br>";

    Auto::altaAuto($auto01);
    Auto::altaAuto($auto02);
    Auto::altaAuto($auto03);
    Auto::altaAuto($auto04);
    Auto::altaAuto($auto05);

    echo "SE MUESTRAN LOS DATOS CARGADOS:<br>";
